    ...
    if (!a.ui.version) {
        ...
        a.extend(a.ui, {
            plugin: {
                ...
                call: function(g, e, i) {
                    if ((e = g.plugins[e]) && g.element[0].parentNode) for (var b = 0; b < e.length; b++) g.options[e[b][0]] && e[b][1].apply(g.element, i)
                }
            },
...
(function(a) {
        ...
        _generatePosition: function(d) {
            ...
            if (this.originalPosition) {
                ...
                if (c.grid) {
                    ...
                    e = b ? !(e - this.offset.click.left < b[0] || e - this.offset.click.left > b[2]) ? e : !(e - this.offset.click.left < b[0]) ? e - c.grid[0] : e + c.grid[0] : e
                }
            }
            return {
    ...
    a.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(d) {
            ...
            if (c.scrollParent[0] != document && c.scrollParent[0].tagName != "HTML") {
                ...
                else if (d.pageY - c.overflowOffset.top < f.scrollSensitivity) c.scrollParent[0].scrollTop = g = c.scrollParent[0].scrollTop - f.scrollSpeed;
    ...
    a.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(d, c) {
            for (var f = a(this).data("draggable"), g = f.options, e = g.snapTolerance, i = c.offset.left, b = i + f.helperProportions.width, h = c.offset.top, j = h + f.helperProportions.height, l = f.snapElements.length - 1; l >= 0; l--) {
                ...
                if (o - e < i && i < n + e && k - e < h && h < m + e || o - e < i && i < n + e && k - e < j && j < m + e || o - e < b && b < n + e && k - e < h && h < m + e || o - e < b && b < n + e && k - e < j && j < m + e) {
                    ...
                    f.snapElements[l].snapping && f.options.snap.release && f.options.snap.release.call(f.element, d, a.extend(f._uiHash(), {
                        snapItem: f.snapElements[l].item
                    }));
...
(function(a) {
    ...
    a.ui.intersect = function(d, c, f) {
        ...
        case "touch":
            return (i >= l && i <= o || b >= l && b <= o || i < l && b > o) && (g >= h && g <= j || e >= h && e <= j || g < h && e > j);
        default:
            return false
        }
    };
...
(function(a) {
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length) for (var f = this.helper || this.element, g = 0; g < this._proportionallyResizeElements.length; g++) {
                ...
                a.browser.msie && (a(f).is(":hidden") || a(f).parents(":hidden").length) || e.css({
    ...
    a.ui.plugin.add("resizable", "containment", {
        ...
        stop: function() {
            ...
            f._helper && !g.animate && /relative/.test(b.css("position")) && a(this).css({
    ...
    a.widget("ui.sortable", a.ui.mouse, {
        ...
        _mouseDrag: function(d) {
            ...
            if (this.options.scroll) {
                ...
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    ...
                    else if (d.pageY - this.overflowOffset.top < c.scrollSensitivity) this.scrollParent[0].scrollTop = f = this.scrollParent[0].scrollTop - c.scrollSpeed;
                    ...
                    if (d.pageY - a(document).scrollTop() < c.scrollSensitivity) f = a(document).scrollTop(a(document).scrollTop() - c.scrollSpeed);
            ...
            for (c = this.items.length - 1; c >= 0; c--) {
                ...
                if (e) if (g != this.currentItem[0] && this.placeholder[e == 1 ? "next" : "prev"]()[0] != g && !a.ui.contains(this.placeholder[0], g) && (this.options.type == "semi-dynamic" ? !a.ui.contains(this.element[0], g) : true)) {
        ...
        _createPlaceholder: function(d) {
            ...
            if (!f.placeholder || f.placeholder.constructor == String) {
                ...
                f.placeholder = {
                    element: function() {
                        var e = a(document.createElement(c.currentItem[0].nodeName)).addClass(g || c.currentItem[0].className + " ui-sortable-placeholder").removeClass("ui-sortable-helper")[0];
        ...
        _generatePosition: function(d) {
            ...
            return {
                top: i - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (a.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : g ? 0 : f.scrollTop()),
...
(function(a) {
    a.effects.explode = function(d) {
        return this.queue(function() {
            ...
            for (var i = g.outerWidth(true), b = g.outerHeight(true), h = 0; h < c; h++) for (var j = 0; j < f; j++) g.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -j * (i / f),
                top: -h * (b / c)
                ...
                top: e.top + h * (b / c) + (d.options.mode == "show" ? 0 : (h - Math.floor(c / 2)) * (b / c)),
...
(function(a) {
    a.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            d.headers.attr("role", "tab").bind("keydown.accordion", function(e) {
                return d._keydown(e)
            ...
            this.menu = a("<ul></ul>").addClass("ui-autocomplete").appendTo(a(this.options.appendTo || "body", f)[0]).mousedown(function(e) {
                ...
                focus: function(e, i) {
                    ...
                    false !== c._trigger("focus", e, {
                        item: i
                    }) && /^key/.test(e.originalEvent.type) && c.element.val(i.value)
                },
...
(function(a, d) {
    ...
    a.extend(c.prototype, {
        ...
        parseDate: function(b, h, j) {
            ...
            for (var o = (j ? j.dayNamesShort : null) || this._defaults.dayNamesShort, n = (j ? j.dayNames : null) || this._defaults.dayNames, k = (j ? j.monthNamesShort : null) || this._defaults.monthNamesShort, m = (j ? j.monthNames : null) || this._defaults.monthNames, p = j = -1, q = -1, s = -1, r = false, u = function(y) {
                    ...
                    z++
                }, z = 0, G = 0; G < b.length; G++) if (r) if (b.charAt(G) == "'" && !u("'")) r = false;
            else x();
        ...
        formatDate: function(b, h, j) {
            ...
            var k = function(u) {
                ...
                q = "",
                s = false;
            if (h) for (var r = 0; r < b.length; r++) if (s) if (b.charAt(r) == "'" && !k("'")) s = false;
            else q += b.charAt(r);
    ...
    a.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            var e = this,
                ...
                j = (e.uiDialog = a("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + i.dialogClass).css({
                    zIndex: i.zIndex
    ...
    a.widget("ui.slider", a.ui.mouse, {
        ...
        _refreshValue: function() {
            ...
            if (this.options.values && this.options.values.length) this.handles.each(function(o) {
                ...
                if (d === "min" && this.orientation === "horizontal") this.range.stop(1, 1)[g ? "animate" : "css"]({
                    width: e + "%"
                }, c.animate);

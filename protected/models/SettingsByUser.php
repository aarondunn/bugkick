...
/**
 * This is the model class for table "{{settings_by_user}}".
 *
 * The followings are the available columns in table '{{settings_by_user}}':
 ...
 */
class SettingsByUser extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, defaultAssignee, defaultLabel, defaultStatus, defaultCompany', 'numerical', 'integerOnly'=>true),
            array('defaultAssignee, defaultLabel, defaultStatus, defaultCompany', 'length', 'max'=>10),
            array('user_id', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('user_id, defaultAssignee, defaultLabel, defaultStatus, defaultCompany', 'safe', 'on'=>'search'),
		);
	}

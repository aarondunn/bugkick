	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','view','getUsersList'),
				'users'=>array('@'),
			),
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
...
/*	public function actionIndex()
	{
        if(!empty($_POST['company'])) {
            ...
            $userByCompany = UserByCompany::model()->findByAttributes(array('company_id'=>$company_id, 'user_id'=>Yii::app()->user->id));

            if(!empty($company) && !empty($userByCompany)) {
                Yii::app()->user->setState('company_id', $company->company_id);
                Yii::app()->user->setState('company_name', $company->company_name);
